...
import { createDashboardCategory } from "@/actions/dashboard/categories/categories";
...
export const DashboardCategoryFormNew = () => {
    ...
    const onSubmit = async (data: TCreateCategoryData) => {
        const response = await createDashboardCategory(data);
